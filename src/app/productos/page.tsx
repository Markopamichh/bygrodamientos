            ...
            if (category.isCustomOrder) {
              return (
                ...
                >
                  ...
                  <div className="p-6">
                    <h2 className="font-display text-xl font-bold text-secondary mb-3">
                      {category.name}
                    </h2>
                    ...
                    <a
                      ...
                      className="flex items-center justify-center gap-2 w-full bg-green-500 hover:bg-green-600 text-white font-medium text-sm py-3 px-4 rounded-lg transition-colors duration-300"
                    >
