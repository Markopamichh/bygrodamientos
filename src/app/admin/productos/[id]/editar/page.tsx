...
export default async function EditarProductoPage({ params }: Props) {
  ...
  const product = {
    ...
    tipo_disponibilidad: ((raw.tipo_disponibilidad as string) === 'encargo' ? 'encargo' : 'stock') as 'stock' | 'encargo',
    proveedor_id:      (raw.proveedor_id as string | null) ?? null,
    url_referencia_proveedor: (raw.url_referencia_proveedor as string | null) ?? null,
