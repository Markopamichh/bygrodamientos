    ...
    <section className="py-20 bg-stone-50">
      <Container>
        <div className="text-center mb-14">
          <p className="text-primary font-medium text-sm tracking-widest uppercase mb-3">Ventajas</p>
        ...
        <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {values.map((value, index) => (
            <div
              key={index}
              className={`reveal stagger-${index + 1} card-accent group bg-white p-7 rounded-xl border border-stone-200 hover:border-stone-300 transition-all duration-500 ease-out-expo hover:shadow-xl hover:shadow-black/5 hover:-translate-y-1`}
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-stone-100 rounded-xl flex items-center justify-center flex-shrink-0 text-stone-600 group-hover:bg-primary group-hover:text-white transition-all duration-500 ease-out-expo">
                  {value.icon}
                </div>
                <div>
