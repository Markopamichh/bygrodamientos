  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-4">
        <div className="w-11 h-11 bg-stone-100 rounded-xl flex items-center justify-center flex-shrink-0 text-stone-600">
        ...
        <div>
          <h4 className="font-medium text-stone-900 mb-1">Dirección</h4>
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <h4 className="font-medium text-stone-900 mb-1">Teléfonos</h4>
          <p className="text-stone-500 text-sm">
            <a href={`tel:${companyInfo.phone}`} className="hover:text-primary transition-colors duration-300">
              {companyInfo.phone}
            </a>
            <br />
            {companyInfo.phone2 && (
              <a href={`tel:${companyInfo.phone2}`} className="hover:text-primary transition-colors duration-300">
                {companyInfo.phone2}
              </a>
            )}
          </p>
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <h4 className="font-medium text-stone-900 mb-1">WhatsApp</h4>
          <a
            href={`https://wa.me/${companyInfo.whatsapp}`}
            target="_blank"
            rel="noopener noreferrer"
            className="text-green-600 hover:text-green-700 transition-colors duration-300 text-sm"
          >
            Enviar mensaje
          </a>
        </div>
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <a
            ...
            className="text-stone-500 hover:text-primary transition-colors duration-300 text-sm"
          >
            {companyInfo.email}
          </a>
        </div>
